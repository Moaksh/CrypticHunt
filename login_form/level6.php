...
if(isset($_POST['sub']))
{
    $qu1 = "select answer from levels where level=6";
    $res1 = $obj->query($qu1);
    $r1 = $res1->fetch();
    $ans = $r1['answer'];
    $eans= $_POST['answer'];
    if($ans==$eans)
    {
        header("location:update.php?pass=car");
    }
}
...
<body style="background-color:  #222">
    ...
    <div align="center">
       <div>
           <cite title="GraphicalImage"> <img src="images/changeimageFormat.jpg" alt="gif" name="IsItHard" width="600px" height="600px" /></cite>
        </div>
