...
if(isset($_POST['sub']))
{
    $qu1 = "select answer from levels where level=2";
    $res1 = $obj->query($qu1);
    $r1 = $res1->fetch();
    $ans = $r1['answer'];
    $eans= $_POST['answer'];
    if($ans==$eans)
    {
        header("location:update.php?pass=findout");
    }
}
...
<body style="background-color:  #222">
    ...
    <div align="center">
        <div>
            <img src="images/ItIsHard.jpg" alt="Life is Hard" name="IsItHard" width="600px" height="600px" />
        </div>
