...
if(isset($_POST['sub']))
{
    $qu1 = "select answer from levels where level=3";
    $res1 = $obj->query($qu1);
    $r1 = $res1->fetch();
    $ans = $r1['answer'];
    $eans= $_POST['answer'];
    if($ans==$eans)
    {
        header("location:update.php?pass=great");
    }
}
...
<html>
    ...
    <div align="center">
        <div>
            ...
            <img src="images/social.jpeg" alt="Life is Hard" name="IsItHard" width="800px" height="500px" />
        </div>
