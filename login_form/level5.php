...
if(isset($_POST['sub']))
{
    $qu1 = "select answer from levels where level=5";
    $res1 = $obj->query($qu1);
    $r1 = $res1->fetch();
    $ans = $r1['answer'];
    $eans= $_POST['answer'];
    if($ans==$eans)
    {
        header("location:update.php?pass=smart");
    }
}
...
<html>
    ...
    <!-- convert it to a word (only for GEEKS)-->
    ...
    <div align="center">
        <div style="background-image:url(images/bck.png)" id="div5">
            <p style="margin-top:130px;font-size: 30px; line-height: 3em;font-family: Curlz MT">
                1100010 <br/>
                1101001 <br/>
                1100111
            </p>
